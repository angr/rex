# this c template assumes that it doesn't need to modify the payload with an address
# we'll probably assume the address of the flag page
# todo we need to do work on parts that require interaction / randomization.
...
int main() {
  ...
  // we will ignore the t2vals.region_addr
  ...
  receive_n(0, leak, t2vals.read_size);
